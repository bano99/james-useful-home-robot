...
def get_pose(j_angles, mount_rpy=[0, 0, 0]):
    ...
    # Joint 6: origin rpy="0 0 3.1416" xyz="0.000 0 0.041"
    # current axis: 0 0 1
...
print("--- TESTING CURRENT STATE (Mount RPY=0 0 0) ---")
x, y, z = get_pose(j_angles, mount_rpy=[0, 0, 0])
print(f"EE Pose: X={x:.4f}, Y={y:.4f}, Z={z:.4f}")

print("\n--- TESTING MOUNT RPY=0 0 1.5708 ---")
x, y, z = get_pose(j_angles, mount_rpy=[0, 0, 1.5708])
print(f"EE Pose: X={x:.4f}, Y={y:.4f}, Z={z:.4f}")

print("\n--- TESTING MOUNT RPY=0 0 3.14159 ---")
x, y, z = get_pose(j_angles, mount_rpy=[0, 0, 3.14159])
print(f"EE Pose: X={x:.4f}, Y={y:.4f}, Z={z:.4f}")
